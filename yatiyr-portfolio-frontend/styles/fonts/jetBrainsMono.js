...
export const JetBrainsMono = `
    ...
    @font-face {
        font-family: 'JetBrainsMono';
        src: url('/fonts/JetBrainsMono/JetBrainsMono-ExtraLight.ttf') format('truetype');
        font-weight: 200;
        font-style: normal;
    }
    ...
    @font-face {
        font-family: 'JetBrainsMono';
        src: url('/fonts/JetBrainsMono/JetBrainsMono-ExtraLightItalic.ttf') format('truetype');
        font-weight: 200;
        font-style: italic;
    }
    ...
    @font-face {
        font-family: 'JetBrainsMono';
        src: url('/fonts/JetBrainsMono/JetBrainsMono-RegularItalic.ttf') format('truetype');
        font-weight: 400;
        font-style: italic;
    }
    ...
    @font-face {
        font-family: 'JetBrainsMono';
        src: url('/fonts/JetBrainsMono/JetBrainsMono-SemiBold.ttf') format('truetype');
        font-weight: 600;
        font-style: normal;
    }
    ...
    @font-face {
        font-family: 'JetBrainsMono';
        src: url('/fonts/JetBrainsMono/JetBrainsMono-SemiBoldItalic.ttf') format('truetype');
        font-weight: 600;
        font-style: italic;
    }
